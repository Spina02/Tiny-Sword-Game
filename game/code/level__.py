...
class YSortCameraGroup(pygame.sprite.Group):
    ...
    #? ---------------------------- render levels ----------------------------
        ...
        for layer in self.tmx_data.visible_layers:
            if layer != self.tmx_data.get_layer_by_name("player"):
                ...
                for x, y, gid in layer:
                    ...
                    if tile:
                        ...
                        if layer == self.tmx_data.get_layer_by_name("sea"):
                            pass
                        # if layer == self.tmx_data.get_layer_by_name("deco"):
                        #     pass
                        ...
                        #        Tile((x,y), [player.obstacle_sprites], 'invisible')
                            ...
                            for gid_, props in self.tmx_data.tile_properties.items():
                                if gid == gid_ and props['frames'] and tile == ti(props['frames'][0].gid):
                                    tile = ti(props['frames'][self.frame_index%len(props["frames"])].gid)
                            #if layer != self.tmx_data.get_layer_by_name("deco"): pass #and layer != self.tmx_data.get_layer_by_name("tree"):
